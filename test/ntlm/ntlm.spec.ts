...
describe('NTLM hashes', function () {
  ...
  const NTLMv1asciiType1 = 'NTLM TlRMTVNTUAABAAAAgoKAAgAAAAAoAAAAAAAAACgAAAAKALpHAAAADw==';
  const NTLMv1asciiType1withDomainAndWS = 'NTLM TlRMTVNTUAABAAAAgrKAAgoACgAoAAAACQAJADIAAAAKALpHAAAAD1VSU0EtTUlOT1JMSUdIVENJVFk=';

  const NTLMv2asciiType1 = 'NTLM TlRMTVNTUAABAAAAAoCIAgAAAAAoAAAAAAAAACgAAAAKALpHAAAADw==';
  const NTLMv2asciiType1withDomainAndWS = 'NTLM TlRMTVNTUAABAAAAArCIAgoACgAoAAAACQAJADIAAAAKALpHAAAAD1VSU0EtTUlOT1JMSUdIVENJVFk=';

  const NTLMv1asciiType2 = 'NTLM TlRMTVNTUAACAAAACgAKADgAAAAGAoECU3J2Tm9uY2UAAAAAAAAAABwAHABCAAAACgC6RwAAAA9VUlNBLU1JTk9SAgAUAFUAUgBTAEEALQBNAEkATgBPAFIAAAAAAA==';
  const NTLMv1ucsType2 = 'NTLM TlRMTVNTUAACAAAAFAAUADgAAAAFAoECU3J2Tm9uY2UAAAAAAAAAABwAHABMAAAACgC6RwAAAA9VAFIAUwBBAC0ATQBJAE4ATwBSAAIAFABVAFIAUwBBAC0ATQBJAE4ATwBSAAAAAAA=';

  const NTLMv2asciiType2 = 'NTLM TlRMTVNTUAACAAAACgAKADgAAAAGAIkCU3J2Tm9uY2UAAAAAAAAAABwAHABCAAAACgC6RwAAAA9VUlNBLU1JTk9SAgAUAFUAUgBTAEEALQBNAEkATgBPAFIAAAAAAA==';
  const NTLMv2ucsType2 = 'NTLM TlRMTVNTUAACAAAAFAAUADgAAAAFAIkCU3J2Tm9uY2UAAAAAAAAAABwAHABMAAAACgC6RwAAAA9VAFIAUwBBAC0ATQBJAE4ATwBSAAIAFABVAFIAUwBBAC0ATQBJAE4ATwBSAAAAAAA=';
  ...
  const NTLMv1asciiType3 = 'NTLM TlRMTVNTUAADAAAAGAAYAGEAAAAYABgAeQAAAAoACgBIAAAABgAGAFIAAAAJAAkAWAAAAAAAAACRAAAABgKBAgoAukcAAAAPVVJTQS1NSU5PUlphcGhvZExJR0hUQ0lUWa2Hym3v40aFucQ8R3qMQtYAZn1okufol+DgDeMQShvyBT8Hx92oLTxImumJ4bAA0w==';
  const NTLMv1ucsType3 = 'NTLM TlRMTVNTUAADAAAAGAAYAHoAAAAYABgAkgAAABQAFABIAAAADAAMAFwAAAASABIAaAAAAAAAAACqAAAABQKBAgoAukcAAAAPVQBSAFMAQQAtAE0ASQBOAE8AUgBaAGEAcABoAG8AZABMAEkARwBIAFQAQwBJAFQAWQCth8pt7+NGhbnEPEd6jELWAGZ9aJLn6Jfg4A3jEEob8gU/B8fdqC08SJrpieGwANM=';

  const NTLMv2asciiType3 = 'NTLM ';
  const NTLMv2ucsType3 = 'NTLM ';

  const NTLMv2asciiType3withFullTargetInfo = 'NTLM ';
  const NTLMv2ucsType3withFullTargetInfo = 'NTLM ';

  it('should create expected Type 1 message. NTLMv1 ASCII', function () {
    const type1 = ntlm.createType1Message(1);
    expect(type1).to.be.equal(NTLMv1asciiType1);
  });
  ...
  it('should create expected Type 1 message. NTLMv2 ASCII with domain and workstation', function () {
    ...
    expect(type1).to.be.equal(NTLMv2asciiType1withDomainAndWS);
  });
  ...
  it('should decode Type 2 message. NTLMv1 ASCII', function () {
    ...
    expect(type2.targetInfo.parsed['DOMAIN']).to.be.equal(domainName.toUpperCase());
  ...
  it('should create expected Type 3 message. NTLMv2 ASCII', function () {
    ...
    let timestamp = buf.readUInt32LE(timestamp_index+4).toString(16) +
  ...
  it('should create expected Type 3 message. NTLMv2 ASCII with full target info', function () {
    ...
    let client_nonce = buf.slice(timestamp_index+8,timestamp_index+16).toString('hex');
    const type3 = ntlm.createType3Message(type2, user, password, hostName.toUpperCase(), domainName.toUpperCase(), client_nonce);
    expect(type3).to.be.equal(NTLMv2asciiType3withFullTargetInfo);
  });
  ...
  it('should create expected Type 3 message. NTLMv2 UCS2 with full target info', function () {
    ...
    let client_nonce = buf.slice(timestamp_index+8,timestamp_index+16).toString('hex');
    const type3 = ntlm.createType3Message(type2, user, password, hostName.toUpperCase(), domainName.toUpperCase(), client_nonce);
    expect(type3).to.be.equal(NTLMv2ucsType3withFullTargetInfo);
  });
