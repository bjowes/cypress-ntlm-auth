declare namespace Cypress {
  interface Chainable<Subject> {
     ...
     * change credentials.
     * @param ntlmHosts array of FQDNs or hostnames of the servers where NTLM authentication shall be
     ...
     * @param username the username for the account to authenticate with
     * @param password the password or the account to authenticate with
     * @param domain (optional) the domain for the account to authenticate with
     * (for AD account authentication). Default value: the domain of the ntlmHost.
     * @param workstation (optional) the workstation name of the client. Default value: `os.hostname()`
     * @param ntlmVersion (optional) the version of the NTLM protocol to use. Valid values are 1 and 2.
     ...
     * @param ntlmHosts array of FQDNs or hostnames of the servers where NTLM or Negotiate authentication with
     ...
     * @example
      ...
      ```
     */
    ntlmSso(ntlmHosts: string[]): Chainable<Subject>;
